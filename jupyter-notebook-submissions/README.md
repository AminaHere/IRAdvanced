# Jupyter Notebook Submissions of ul-ecstatic-dijkstra
...
```
docker build -t registry.webis.de/code-research/tira/tira-user-ul-ecstatic-dijkstra/submission:0.0.1 .
```
...
```
tira-run --image registry.webis.de/code-research/tira/tira-user-ul-ecstatic-dijkstra/submission:0.0.1 --input-dataset workshop-on-open-web-search/query-processing-20231027-training
```
...
```
docker push registry.webis.de/code-research/tira/tira-user-ul-ecstatic-dijkstra/submission:0.0.1
```
